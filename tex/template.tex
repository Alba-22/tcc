...
\subsection{Padrão Observer}
\subsection{Padrão State}
\subsection{Padrão Builder}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/getInformationFromNetwork.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/variables.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/adhoc_widget.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/adhoc_getinfo.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/notifier.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/notifier_builder.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/notifier_controller.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/controller_with_states.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/with_state_page.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/sealed_states.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/states/example_form.png}
...
A partir do exemplo apresentado na Figura \ref{fig:example_form}, para criar esse formulário de demonstração é necessário criar as funções de validação para cada um dos campos para que seja feita a validação de cada um dos campos, como visto na Figura \ref{fig:form_adhoc_validators}, e adicionar essa função de validação em cada campo, assim como o \textit{TextEditingController} de cada campo, como exemplificado na Figura \ref{form_adhoc_textformfield}. Além disso, para que o botão reaja à validação do formulário, é necessário criar uma variável booleana e uma função que irá verificar se a validação está correta e chamar o método \textit{setState} para atualizar a tela com o novo valor da variável, como na Figura \ref{form_adhoc_checkFields}. Essa função deve ser chamada sempre que houver uma alteração em cada formulário, como é possível visualizar na Figura \ref{form_adhoc_textformfield}

\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/forms/form_adhoc_validators.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/forms/form_adhoc_textformfield.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.65\textwidth]{figures/forms/form_adhoc_checkFields.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.85\textwidth]{figures/forms/form_validator.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.85\textwidth]{figures/forms/form_manager.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.85\textwidth]{figures/forms/set_forms.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.85\textwidth]{figures/forms/custom_text_field.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.85\textwidth]{figures/forms/use_of_form_proposal.png}
    \caption{Uso dos formulários com reatividade no código da interface gráfica}
    \label{fig:use_of_form_proposal}
\end{figure}


\section{Uma proposta de arquitetura}

\section{Funcionamento de Aplicações Offline de Forma Contínua}
