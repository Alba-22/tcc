...
\data{2024}
\orientador{Marcelo de Almeida Maia} %TCC
...
\begin{folhadeaprovacao}
    ...
    Trabalho aprovado. \imprimirlocal, 01 de abrir de 2024: %TCC:

    \assinatura{\textbf{\imprimirorientador} \\ Orientador}
    \assinatura{\textbf{Rodrigo Sanches Miani}}% \\ Convidado 1} %TCC:
    \assinatura{\textbf{Paulo Rodolfo da Silva Leite Coelho}}% \\ Convidado 2} %TCC:
...
Para a criação de projetos de software melhores que atinjam as qualidades descritas, têm-se diversos trabalhos e autores amplamente reconhecidos na área de Engenharia de Software e Arquitetura de Software, como \citeonline{Martin17}, \citeonline{EVANS}, \citeonline{COCKBURN} e \citeonline{GOF}.
...
\begin{figure}[ht]
    ...
    \caption{Diagrama da Estrutura do Padrão Builder. Fonte: Do Autor.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.8\textwidth]{figures/bibliographical_review/hex_arch_diagram.png}
    \caption{Diagrama representativo da Arquitetura Hexagonal. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Diagrama representativo da Arquitetura Limpa. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Exemplo de Null Safety em Dart. Fonte: Do Autor.}
    \label{fig:null_safety}
\end{figure}

Sobre o Flutter em si, ele foi apresentado inicialmente em 2015 e lançado em versão estável em dezembro de 2018. Ele se caracteriza como um \textit{framework} para construção de interfaces gráficas que utiliza da linguagem Dart para construir aplicações compiladas nativamente para diversas plataformas, como \textit{mobile}, \textit{web}, \textit{desktop} e sistemas embarcados a partir de uma única base de código, com destaque para o fato das aplicações rodarem a 60 quadros por segundo e com o desenvolvedor conseguindo controlar cada pixel na tela.
...
\begin{figure}[ht]
    ...
    \caption{Exemplo de interface declarativa. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Diagrama dos estados possíveis em uma ação assíncrona. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Função para simular uma ação assíncrona. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Variáveis para representar os estados da página. Fonte: Do Autor.}
    \label{fig:variables}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Método \textit{build} para construção da tela da abordagem \textit{adhoc}. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Função que realizará a alteração dos estados de acordo com o andamento da ação assíncrona. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Classe \textit{Notifier} que implementa o \textit{Observer Pattern}. Fonte: Do Autor.}
    \label{fig:notifier}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Classe \textit{NotifierBuilder}, um ouvinte do \textit{Notifier}. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Classe \textit{Controller}, responsável por gerenciar o estado da aplicação. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Código da UI utilizando o \textit{Controller} criado. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Representação de código utilizando polimorfismo. Fonte: Do Autor.}
    \label{fig:states}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Nova versão do \textit{Controller} utilizando as classes de estado criadas. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{UI utilizando as classes de estado criadas. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Alteração nas classes de estados, introduzido o conceito de classes seladas. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{UI utilizando \textit{pattern matching} para exibição dos componentes de acordo com o estado. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Exemplo de criação de formulário com Flutter. Fonte: Do Autor.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.8\textwidth]{figures/forms/form_preview_invalid.png}
    \caption{Exemplos de formulários inválidos. Fonte: Do Autor.}
    \label{fig:form_preview_invalid}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=.8\textwidth]{figures/forms/form_preview_valid.png}
    \caption{Exemplos de formulários válidos. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Funções para validação dos campos da demonstração. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Widget TextFormField para o campo de e-mail. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Função para verificação da validade. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Classe Validator com aplicação do \textit{Builder Pattern}. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Classe \textit{FormManager}, responsável por encapsular todo o registro e validação dos formulários. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Inicialização dos formulários na tela. Fonte: Do Autor.}
    \label{fig:set_forms}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Criação do componente personalizado para um formulário. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Uso dos formulários com reatividade no código da interface gráfica. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Exemplo da visualização dos Dialog no iOS e Android, respectivamente. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Exemplo direto do uso de diferentes Dialogs de acordo com o SO no qual a aplicação está rodando. Fonte: Do Autor.}
...
Diante dos problemas apresentados, é possível introduzir o padrão de projeto \textit{Factory}, no qual a partir de uma classe abstrata pode-se definir qual será a interface necessária para a criação de um \textit{Dialog}, com a aplicação instanciando a devida implementação do \textit{Dialog} de acordo com o sistema operacional no qual a aplicação está sendo executada.Para implementar esse padrão, é necessário primeiramente criar a interface que todas as implementações de \textit{Dialog} devem seguir. Essa interface receberá o título, conteúdo e as ações possíveis para os botões do \textit{Dialog}, como visto na Figura \ref{fig:base_dialog}.

\begin{figure}[ht]
    \centering
    \includegraphics[width=.85\textwidth, trim={0 30 0 100}, clip]{figures/dialog/base_dialog.png}
    \caption{Interface para criação de Dialogs. Fonte: Do Autor.}
    \label{fig:base_dialog}
\end{figure}

Em seguida, deve-se criar as implementações dos \textit{Dialogs} a partir dessa interface criada, com cada uma sendo responsável por exibir o componente correto para aquela plataforma, como visto na Figura \ref{fig:dialog_implementations}.

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth, trim={0 30 0 100}, clip]{figures/dialog/dialog_implementations.png}
    \caption{Implementações dos \textit{Dialogs} com base na interface \textit{BaseDialog}. Fonte: Do Autor.}
    \label{fig:dialog_implementations}
\end{figure}

Com as implementações da interface \textit{BaseDialog} feita, deve-se agora realizar a configuração de qual \textit{Dialog} será utilizado, de forma que isso deve ser feito na inicialização da aplicação, na função \textit{main}, com a atribuição da variável global \textit{dialog}, como pode ser visto na Figura \ref{fig:dialog_init}

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth, trim={0 30 0 100}, clip]{figures/dialog/dialog_init.png}
    \caption{Inicialização do \textit{Dialog} de acordo com o Sistema Operacional. Fonte: Do Autor.}
    \label{fig:dialog_init}
\end{figure}

O uso do padrão pode ser visualizado na Figura \ref{fig:dialog_factory_use}, no qual é chamada diretamente o método \textit{show} na variável \textit{dialog}, em que são passados argumentos como título, conteúdo e ações, definidos na interface \textit{BaseDialog}

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth, trim={0 30 0 100}, clip]{figures/dialog/dialog_factory_use.png}
    \caption{Uso do padrão \textit{Factory}. Fonte: Do Autor.}
    \label{fig:dialog_factory_use}
\end{figure}

Com essa implementação utilizando o padrão \textit{Factory}, quando for necessário adicionar uma nova plataforma, bastará criar a nova implementação da interface \textit{BaseDialog} e adicionar uma única nova condição na inicialização da aplicação. Dessa forma, qualquer parte da interface gráfica poderá exibir \textit{Dialogs} sem ter que se preocupar com qual a plataforma na qual a aplicação está sendo executada, de forma a focar apenas no conteúdo que o \textit{Dialog} deve receber. É importante destacar que esse padrão pode ser aplicado para qualquer parte da interface, desde partes que chamem componentes de interface comuns nos sistemas operacionais, como \textit{overlays} de carregamento, \textit{date pickers}, \textit{dialogs}, até componentes mais específicos da aplicação em si, como \textit{cards}, campos de texto, botões, etc.
...
\begin{figure}[ht]
    ...
    \caption{Protótipo da Aplicação FlutterPad. Fonte: Comunidade Flutterando.}
...
\begin{figure}[ht]
    ...
    \caption{Estrutura de arquivos do repositório do projeto. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Diagrama da Arquitetura Desenvolvida. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Código para classe TaskEntity. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Classe genérica para representação de casos de uso. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Caso de uso para marcação de realização de tarefas. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Interface do Repositório de Tarefas. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Classe que representa uma tarefa no banco de dados. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Método do \textit{TasksLocalDatasource} que salva uma tarefa no banco de dados. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Função para fazer o registro de instâncias antes da inicialização da aplicação. Fonte: Do Autor.}
...
\begin{figure}[ht]
    ...
    \caption{Diagrama da Arquitetura Simplificada. Fonte: Do Autor.}
