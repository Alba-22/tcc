...
\begin{resumo}
    No desenvolvimento dos primeiros softwares só se havia uma preocupação: que ele funcionasse. Porém, com o passar do tempo e os avanços e estudos na área de Engenharia de Software, tanto pelo mundo acadêmico quanto pelo mercado, passaram a ser desenvolvidas mais e mais ferramentas, técnicas e modos de se fazer um bom software, que seja fácil de ler o código e de dar manutenção, de forma que ele consiga evoluir e atender a novas demandas exigidas. Esse trabalho tem como objetivo estudar a aplicação de algumas dessas técnicas em aplicações construídas com o \textit{framework} Flutter, de forma a mostrar como essas técnicas, tanto de projeto de código quanto de arquitetura, podem trazer benefícios para o software sendo contruído. Assim, nesse trabalho tem-se um estudo feito em cima dos principais princípios que regem a qualidade de um software, assim como algumas propostas de arquitetura e metodologias de desenvolvimento. Além disso, há implementação de padrões de projeto em aplicações Flutter, mostrando o passo a passo e justificando as melhorias causadas no código, além da criação de duas propostas de arquitetura para aplicações Flutter baseadas nos estudos feitos em cima de \textit{Domain Driven Design}, \textit{Clean Architecture} e \textit{Hexagonal Architecture}.
